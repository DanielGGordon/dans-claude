...
const IDS = ['gpt-6-astra', 'gpt-5.6-terra', 'gpt-5.6-sol', 'composer-2.5', 'cursor-grok-4.6-high', 'glm-5.2-high']
const TASKS = [['bulk', 'gpt-5.6-terra'], ['cheap', 'composer-2.5'], ['recency', 'cursor-grok-4.6-high'], ['second-review', 'gpt-6-astra'], ['fable-fallback', 'gpt-6-astra']]
