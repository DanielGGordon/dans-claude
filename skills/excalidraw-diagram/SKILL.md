...
description: Create Excalidraw diagram JSON files (.excalidraw) that make visual arguments. Use when the user wants a concept, architecture, or workflow diagram, a flowchart or sequence diagram, wants to sketch how a system works, or mentions Excalidraw. Not for data charts or graphs — use dataviz for those.
---
